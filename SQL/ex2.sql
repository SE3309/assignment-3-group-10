...
CREATE TABLE UserCollection (
    ...
    dateCreated DATE,
    PRIMARY KEY (username, listName, dateCreated),
    FOREIGN KEY (username) REFERENCES User(username) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (listName, dateCreated) REFERENCES Collection(listName, dateCreated) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE CollectionMovies (
    ...
    releaseDate DATE NOT NULL,
    dateCreated DATE,
    PRIMARY KEY (username, listName, movieTitle, releaseDate, dateCreated),
    FOREIGN KEY (username) REFERENCES User(username) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (listName, dateCreated) REFERENCES Collection(listName, dateCreated) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (movieTitle, releaseDate) REFERENCES Movie(title, releaseDate) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Collection (
    ...
    description TEXT,
    dateCreated DATE,
    PRIMARY KEY (listName, dateCreated)
);
DESCRIBE Collection;
